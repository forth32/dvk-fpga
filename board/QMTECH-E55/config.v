...
//  МС1201.02   К1801ВМ2     ДВК-3              55 Мгц
...
//****************************************
 ...
 `define clkref 55000000    // тактовая частота процессора в герцах
 `define PLL_MUL 11         // умножитель PLL
 `define PLL_DIV 10         // делитель PLL
 `define CPUSLOW 15         // число тактов, пропускаемых процессором в режиме замедления
