...
//****************************************
 ...
 `define PLL_DIV 20          // делитель PLL
...
//****************************************
 ...
 `define PLL_DIV 20         // Определение типа модуля соединительной платы-корзины
 `define CPUSLOW 15         // число тактов, пропускаемых процессором в режиме замедления
...
// Делитель частоты ля тактировани SD-карты
`define SD_DIV 80
...
// Переопределение опорной тактовой частоты для этого варианта PLL
`define clkref 960000000/`PLL_DIV
